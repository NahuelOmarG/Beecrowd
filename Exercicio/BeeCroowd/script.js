...
while(contagemPUMs < limitePUMs){ 
    //Enquanto a condicao que tiver for verdadera , ele ira a repetir.
  if (cont % 4 != 0){
    console.log(cont)
    acumulador += cont + " "
  } else{
...
function testar(){
     ...
     if(indice != -1){
        ...
        console.log("Valor no encontrado :P")
     }
     }
     function cadastrar (){
        ...
        //idades.push(Number(prompt("Digite o numero para cadastrar: ")))
     ...
     document.getElementById("saida").innerHTML = idades

     //innerHTML
     
     //console.log(idade.indexOf(numero)
